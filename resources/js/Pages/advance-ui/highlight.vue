...
<template>
  <Layout>
    <PageHeader title="Highlight" pageTitle="Advance UI" />
    <BRow>
      <BCol lg="12">
        <BCard no-body>
          <BCardHeader class="align-items-center d-flex">
            <div class="flex-grow-1">
              <BCardTitle class="mb-0">HTML Highlight</BCardTitle>
            </div>
          </BCardHeader>
...
&lt;html&gt;
    &lt;head&gt;
        &lt;title&gt;SpeedZone Express - Responsive Admin Dashboard Template&lt;/title&gt;
    &lt;/head&gt;
    &lt;body&gt;
        &lt;div&gt;
    ...
    <BRow>
      <BCol lg="12">
        <BCard no-body>
          <BCardHeader class="align-items-center d-flex">
            <div class="flex-grow-1">
              <BCardTitle class="mb-0">CSS Highlight</BCardTitle>
            </div>
          </BCardHeader>
    ...
    <BRow>
      <BCol lg="12">
        <BCard no-body>
          <BCardHeader class="align-items-center d-flex">
            <div class="flex-grow-1">
              <BCardTitle class="mb-0">Javascript Highlight</BCardTitle>
            </div>
          </BCardHeader>
