...
<template>
    <Layout>
        <PageHeader title="Basic Action" pageTitle="Email" />
        <BRow>
            <BCol lg="12">
                            ...
                            <div class="content"
                                                ...
                                                <tr
                                                    ...
                                                    <td class="content-block"
                                                        ...
                                                        <div style="display: flex; align-items: center;">
                                                            <img src="@assets/images/users/avatar-3.jpg" alt="" height="35"
                                ...
                                <div style="text-align: center; margin: 0px auto;">
                                    <ul
                                        ...
                                        <li>
                                            <BLink href="#" style="color: #495057;">Help Center</BLink>
                                        </li>
                                        <li>
                                            <BLink href="#" style="color: #495057;">Support 24/7</BLink>
                                        </li>
                                        <li>
                                            <BLink href="#" style="color: #495057;">Account</BLink>
                                        </li>
                                    </ul>
                                    <p
                        ...
                        <td class="container" width="600"
                            ...
                            <div class="content"
                                                ...
                                                <tr
                                                    ...
                                                    <td class="content-block"
                                                        ...
                                                        <div style="text-align: center;">
                                                            <lock-icon class="icon-sm" style="color: #0ab39c;fill: rgba(10,179,156,.16); height: 30px; width: 30px;"></lock-icon>
                                                        </div>
                                                    </td>
                                                </tr>
                                                <tr
                                                    ...
                                                    <td class="content-block"
                                                        ...
                                                        <h4
                                                            ...
                                                            Change or reset your password</h4>
                                                    </td>
                                                </tr>
                                                <tr
                                                    style="font-family: 'Roboto', sans-serif; box-sizing: border-box; font-size: 14px; margin: 0;">
                                ...
                                <div style="text-align: center; margin: 28px auto 0px auto;">
                                    <h4>Need Help ?</h4>
                                    <p style="color: #878a99;">Please send and feedback or bug info to <BLink href=""
                                            style="font-weight: 500px;">info@velzon.com</BLink>
                                    </p>
                                    <p
                                        style="font-family: 'Roboto', sans-serif; font-size: 14px;color: #98a6ad; margin: 0px;">
                                        2022 OWL Delivery. Design & Develop by OWL Delivery</p>
