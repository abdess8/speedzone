                ...
                <BCard no-body id="contactList">
                    <BCardHeader>
                        <div class="d-flex align-items center">
                            <h5 class="mb-0 flex-grow-1">The top NFTs ranking on OWL Delivery</h5>
                    ...
                    <BCardBody>
                                    ...
                                    <tr v-for="(data, index) of resultQuery" :key="index">
                                        ...
                                        <td class="collection">
                                            <div class="d-flex align-items-center">
                                                ...
                                                <Link href="/apps/nft-item-detail" class="text-body"> {{ data.collection
                                                }}</Link>
                                            </div>
                                        </td>
                        ...
                        <div class="d-flex justify-content-end mt-3" v-if="resultQuery.length >= 1">
                            <div class="pagination-wrap hstack gap-2">
                                <Link class="page-item pagination-prev" href="#" :disabled="page <= 1" @click="page--">
                                    Previous
                                </Link>
                                <ul class="pagination listjs-pagination mb-0">
                                    <li :class="{
                                        ...
                                        <Link class="page" href="#">{{ pageNumber }}</Link>
                                    </li>
                                </ul>
                                <Link class="page-item pagination-next" href="#" :disabled="page >= pages.length"
                                    @click="page++">
                                    Next
                                </Link>
                            </div>
