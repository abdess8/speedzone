                            ...
                            <BRow class="justify-content-center g-0">
                                ...
                                <BCol lg="6">
                                    <div class="p-lg-5 p-4">
                                        ...
                                        <BAlert :model-value="true" variant="warning" class="mb-2 mx-2 border-0 text-center">Enter your email and
                                            instructions will be sent to you!</BAlert>
                                        ...
                                        <div class="mt-5 text-center">
                                            <p class="mb-0">Wait, I remember my password...
                                                <Link href="/auth/signin-cover" class="fw-semibold text-primary text-decoration-underline"> Click
                                                here </Link>
                                            </p>
                                        </div>
                                    </div>
