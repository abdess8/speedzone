...
export default {
    ...
    data() {
        return {
            searchQuery: null,
            candidateList: [{ id: 1, img: avatar10, name: "Tonya Noble", username: "@tonya", designation: "Web Developer" },
            { id: 2, img: avatar1, name: "Nicholas Ball", username: "@nicholas", designation: "Assistant / Store Keeper" },
            { id: 3, img: avatar9, name: "Zynthia Marrow", username: "@zynthia", designation: "Full Stack Engineer" },
            { id: 4, img: avatar2, name: "Cheryl Moore", username: "@cheryl", designation: "Product Designer" },
            { id: 5, img: avatar5, name: "Jennifer Bailey", username: "@jennifer", designation: "Marketing Director" },
            { id: 6, img: avatar8, name: "Hadley Leonard", username: "@hadley", designation: "Executive, HR Operations" }]
        };
    },
    mounted() {
                ...
                <BCardBody class="bg-danger-subtle">
                    <div class="d-flex align-items-center">
                        ...
                        <div class="flex-grow-1 ms-3">
                            <h6 class="fs-16">Invite your friends to SpeedZone Express</h6>
