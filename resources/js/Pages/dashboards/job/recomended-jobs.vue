                            ...
                            <div class="gridjs-footer">
                                <div class="gridjs-pagination">
                                    ...
                                    <div class="gridjs-pages">
                                        <button tabindex="0" role="button" title="Previous" href="#" :disabled="page <= 1" @click="page--">Previous</button>
                                        ...
                                        <button tabindex="0" role="button" title="Next" :disabled="page >= pages.length" @click="page++">Next</button>
                                    </div>
                                </div>
                            </div>
