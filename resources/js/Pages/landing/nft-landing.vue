    ...
    <div class="layout-wrapper landing">
            ...
            <BContainer>
                ...
                <BCollapse class="navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav mx-auto mt-2 mt-lg-0" id="navbar-example">
                        ...
                        <li class="nav-item">
                            <BLink class="nav-link" href="#wallet" @click.prevent="scrollToSection('wallet')">Wallet
                            </BLink>
                        </li>
                        <li class="nav-item">
                            <BLink class="nav-link" href="#marketplace" @click.prevent="scrollToSection('marketplace')">Marketplace</BLink>
                        </li>
                        <li class="nav-item">
                        ...
                        <li class="nav-item">
                            <BLink class="nav-link" href="#creators" @click.prevent="scrollToSection('creators')">
                                Creators</BLink>
                        </li>
                    </ul>

                    <div class="">
                        <Link href="/apps/nft-wallet" class="btn btn-primary">Wallet Connect</Link>
                    </div>
                </BCollapse>
                    ...
                    <BCol lg="8" sm="10">
                        <div class="text-center">
                            ...
                            <div class="hstack gap-2 justify-content-center">
                                <Link href="/apps/nft-create" class="btn btn-primary">Create Own <i
                                        class="ri-arrow-right-line align-middle ms-1"></i></Link>
                                <Link href="/apps/nft-explore" class="btn btn-secondary">Explore Now <i
                                        class="ri-arrow-right-line align-middle ms-1"></i></Link>
                            </div>
                        </div>
                    </BCol>
        ...
        <section class="section" id="wallet">
            <BContainer>
                ...
                <BRow class="g-4">
                    <BCol lg="4">
                        <BCard no-body class="text-center border shadow-none">
        ...
        <section class="section bg-light" id="marketplace">
            <BContainer>
                ...
                <BRow>
                    <BCol lg="4" class="product-item artwork crypto-card 3d-style">
                        <BCard no-body class="explore-box card-animate">
                            ...
                            <BCardBody>
                                ...
                                <h5 class="mb-1">
                                    <Link href="/apps/nft-item-detail">Creative Filtered
                                        Portrait</Link>
                                </h5>
                    ...
                    <BCol lg="4" class="product-item music crypto-card games">
                        <BCard no-body class="explore-box card-animate">
                            <div class="bookmark-icon position-absolute top-0 end-0 p-2">
                                <BButton type="button" class="btn btn-icon active" data-bs-toggle="button"
                            ...
                            <BCardBody>
                                <p class="fw-medium mb-0 float-end"><i class="mdi mdi-heart text-danger align-middle"></i>
                                    23.63k </p>
                                <h5 class="mb-1">
                                    <Link href="/apps/nft-item-detail">The Chirstoper</Link>
                                </h5>
                    ...
                    <BCol lg="4" class="product-item artwork music games">
                        <BCard no-body class="explore-box card-animate">
                            <div class="bookmark-icon position-absolute top-0 end-0 p-2">
                                <BButton type="button" class="btn btn-icon active" data-bs-toggle="button"
                                    aria-pressed="true"><i class="mdi mdi-cards-heart fs-16"></i></BButton>
                            ...
                            <BCardBody>
                                <p class="fw-medium mb-0 float-end"><i class="mdi mdi-heart text-danger align-middle"></i>
                                    15.93k </p>
                                <h5 class="mb-1">
                                    <Link href="/apps/nft-item-detail">Evolved Reality</Link>
                                </h5>
                    ...
                    <BCol lg="4" class="product-item crypto-card 3d-style">
                        <BCard no-body class="explore-box card-animate">
                            <div class="bookmark-icon position-absolute top-0 end-0 p-2">
                                <BButton type="button" class="btn btn-icon active" data-bs-toggle="button"
                                    aria-pressed="true"><i class="mdi mdi-cards-heart fs-16"></i></BButton>
                            ...
                            <BCardBody>
                                ...
                                <h5 class="mb-1">
                                    <Link href="/apps/nft-item-detail">Abstract Face Painting</Link>
                                </h5>
                    ...
                    <BCol lg="4" class="product-item games music 3d-style">
                        <BCard no-body class="explore-box card-animate">
                            <div class="bookmark-icon position-absolute top-0 end-0 p-2">
                                <BButton type="button" class="btn btn-icon active" data-bs-toggle="button"
                                    aria-pressed="true"><i class="mdi mdi-cards-heart fs-16"></i></BButton>
                            ...
                            <BCardBody>
                                ...
                                <h5 class="mb-1">
                                    <Link href="/apps/nft-item-detail">Long-tailed Macaque</Link>
                                </h5>
                    ...
                    <BCol lg="4" class="product-item artwork music crypto-card">
                        <BCard no-body class="explore-box card-animate">
                            <div class="bookmark-icon position-absolute top-0 end-0 p-2">
                                <BButton type="button" class="btn btn-icon active" data-bs-toggle="button"
                                    aria-pressed="true"><i class="mdi mdi-cards-heart fs-16"></i></BButton>
                            ...
                            <BCardBody>
                                ...
                                <h5 class="mb-1">
                                    <Link href="/apps/nft-item-detail">Robotic Body Art</Link>
                                </h5>
                                <p class="text-muted mb-0">Artwork</p>
                            </BCardBody>
                            <BCardFooter class="border-top border-top-dashed">
                    ...
                    <BCol lg="12">
                        <div class="swiper mySwiper pb-4">
                            <swiper class="swiper responsive-swiper rounded gallery-light pb-4" :loop="true"
                                :autoplay="true" :modules="[Autoplay, Pagination]" :slidesPerView="1" :spaceBetween="10"
                ...
                <BRow class="justify-content-center">
                    <BCol lg="12">
                        <div class="d-flex align-items-center mb-5">
                            ...
                            <Link href="/apps/nft-explore" class="btn btn-primary">View All <i
                                    class="ri-arrow-right-line align-bottom"></i></Link>
                        </div>
                    </BCol>
                </BRow>
                <BRow>
                    <BCol lg="4">
                        <BCard no-body class="explore-box card-animate border">
                            <BCardBody>
                                ...
                                <div class="mt-3">
                                    ...
                                    <h6 class="fs-16 mb-0">
                                        <Link href="/apps/nft-item-detail">Patterns arts &amp;
                                            culture</Link>
                                    </h6>
                                </div>
                            </BCardBody>
                        ...
                        <BCard no-body class="explore-box card-animate border">
                            <BCardBody>
                                <div class="d-flex align-items-center mb-3">
                                    ...
                                    <div class="bookmark-icon">
                                        <BButton type="button" class="btn btn-icon" data-bs-toggle="button"
                                            aria-pressed="true"><i class="mdi mdi-cards-heart fs-16"></i></BButton>
                                    </div>
                                </div>
                                <div class="explore-place-bid-img overflow-hidden rounded">
                        ...
                        <BCard no-body class="explore-box card-animate border">
                            <BCardBody>
                                ...
                                <div class="mt-3">
                                    ...
                                    <h6 class="fs-16 mb-0">
                                        <Link href="/apps/nft-item-detail">Long-tailed
                                            macaque</Link>
                                    </h6>
                                </div>
                            </BCardBody>
                        ...
                        <BCard no-body>
                            <BCardBody>
                                <div class="d-flex">
                                    ...
                                    <div>
                                        <BDropdown variant="ghost-primary" right toggle-class="arrow-none btn-icon"
                                            class="float-end" no-caret>
                                            <template #button-content><i
                                                    class="ri-more-fill align-middle fs-16"></i></template>
                                            <BDropdownItem href="#">Share</BDropdownItem>
                                            <BDropdownItem href="#">Report</BDropdownItem>
                                        </BDropdown>
                                    </div>
                                </div>
                            </BCardBody>
        ...
        <section class="py-5 bg-primary position-relative">
            ...
            <BContainer>
                <BRow class="align-items-center gy-4">
                    ...
                    <BCol sm="auto">
                        <div>
                            <Link href="/apps/nft-create" class="btn bg-gradient btn-success me-1">Create NFT
                            </Link>
                            <Link href="/apps/nft-explore" class="btn bg-gradient btn-secondary">Discover More
                            </Link>
                        </div>
                    </BCol>
