...
<template>
    <Layout>
        <PageHeader title="Timeline" pageTitle="Pages" />
        <BRow>
            <BCol lg="12">
                <div>
                        ...
                        <div class="timeline-item right">
                            ...
                            <div class="content">
                                ...
                                <p class="text-muted fst-italic mb-2">" This is an awesome admin dashboard template. It
                                    ...
                                    only templates using bootstrap 5.1.3 so far). I integrated it into a Rails 6 project.
                                    Needs manual integration work of course but the template structure made it easy. "
                                </p>
                                <div class="hstack gap-2">
                                    <BLink class="btn btn-sm bg-light"><span class="me-1">&#128151;</span> 35</BLink>
                                    <BLink class="btn btn-sm btn-light"><span class="me-1">&#128077;</span> 10</BLink>
                                    <BLink class="btn btn-sm btn-light"><span class="me-1">&#128591;</span> 10</BLink>
                                </div>
                            </div>
                        </div>
