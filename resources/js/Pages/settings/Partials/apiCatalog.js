...
const ORDER_LIST_ITEM = {
  ...
  tracking_url: 'https://delivery.oowlmedia.com/orders/SPD-2026-583920',
  ...
  store: {
    ...
    category: 'Fashion',
    logo_url: 'https://delivery.oowlmedia.com/storage/stores/12/logo.png',
  },
  store_id: 12,
  partner_id: null,
...
const CREATED_ORDER = {
  ...
  tracking_url: 'https://delivery.oowlmedia.com/orders/SPD-2026-771048',
  status: 'CREATED',
...
export const ENDPOINTS = [
  {
    ...
    responses: [
      { status: 200, sample: { data: [ORDER_LIST_ITEM], ...PAGINATION('https://delivery.oowlmedia.com/api/orders', 137) } },
...

  {
    ...
    responses: [
      { status: 200, sample: { data: [PICKUP_REQUEST], ...PAGINATION('https://delivery.oowlmedia.com/api/pickup-requests', 12) } },
      { status: 401, sample: UNAUTHORIZED },
    ],
  },
    ...
    responses: [
      {
        ...
        sample: {
          ...
          ...PAGINATION('https://delivery.oowlmedia.com/api/cities', 48),
        },
      },
    ],
  },
    ...
    responses: [
      {
        ...
        sample: {
          ...
          ...PAGINATION('https://delivery.oowlmedia.com/api/sectors', 214),
        },
      },
    ],
  },
