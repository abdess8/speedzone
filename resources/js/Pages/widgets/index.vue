...
import SessionsCounties from "../dashboards/analytics/sessions-countries.vue";
...
export default {
  data() {
    return {
      ...
      candidateList: [{ id: "1", name: "Anna Adame", img: avatar1, username: "@Anna", designation: "Web Developer" },
      { id: "2", name: "Patricia Cavin", img: avatar2, username: "@Patricia", designation: "Web Developer" },
      { id: "3", name: "Jason Tran", img: avatar3, username: "@Jason", designation: "Magento Developer" },
      { id: "4", name: "Cheryl Moore", img: avatar4, username: "@Cheryl", designation: "Product Designer" },
      { id: "5", name: "Jennifer Bailey", img: avatar5, username: "@Jennifer", designation: "Marketing Director" },
      ],
  ...
  methods: {
    ...
    updateQuantity(productQty, itemAmount, priceselection) {
      // Calculate the total price based on the quantity and item amount
      ...
      // You can also update any other properties or perform additional logic here
    },

    plusamount() {
      event.target.previousElementSibling.value++;
      var itemAmount = event.target.parentElement?.parentElement?.previousElementSibling?.querySelector(".product-price")?.value;

      var priceselection = event.target?.parentElement?.parentElement?.nextElementSibling?.querySelector(".product-line-price");
      var productQty = event.target.parentElement.querySelector(".product-quantity").value;
    ...
    minusamount() {
      ...
      var itemAmount = event.target.parentElement?.parentElement?.nextElementSibling?.querySelector(".product-price")?.value;
      var priceselection = event.target?.parentElement?.parentElement?.nextElementSibling?.querySelector(".product-line-price");
      var productQty = event.target.parentElement.querySelector(".product-quantity").value;
...
<template>
  <Layout>
    <PageHeader title="Widgets" pageTitle="OWL Delivery" />
    <BRow>
      <BCol cols="12">
          ...
          <BCardBody>
            <div class="d-flex align-items-center">
              ...
              <div class="flex-shrink-0 align-self-center">
                <BBadge variant="white" class="bg-white bg-opacity-25 text-white fs-12"><i class="ri-arrow-up-s-line fs-13 align-middle me-1"></i>6.11 %<span> </span>
                </BBadge>
              </div>
            </div>
          </BCardBody>
        ...
        <BCard no-body class="card-height-100">
          <BCardBody>
            <div class="d-flex align-items-center">
              ...
              <div class="flex-shrink-0 align-self-center">
                <BBadge variant="danger-subtle" class="bg-danger-subtle text-danger fs-12"><i class="ri-arrow-down-s-line fs-13 align-middle me-1"></i>10.35 %<span> </span>
                </BBadge>
              </div>
            </div>
          </BCardBody>
        ...
        <BCard no-body class="card-height-100">
          <BCardBody>
            <div class="d-flex align-items-center">
              ...
              <div class="flex-shrink-0 align-self-center">
                <BBadge variant="success-subtle" class="bg-success-subtle text-success fs-12"><i class="ri-arrow-up-s-line fs-13 align-middle me-1"></i>22.96 %<span> </span>
                </BBadge>
              </div>
            </div>
          </BCardBody>
        ...
        <BCard no-body class="card-height-100">
          <BCardBody>
            <div class="d-flex align-items-center">
              ...
              <div class="flex-shrink-0 align-self-center">
                <BBadge variant="success-subtle" class="bg-success-subtle text-success fs-12"><i class="ri-arrow-up-s-line fs-13 align-middle me-1"></i>16.31 %<span> </span>
                </BBadge>
              </div>
            </div>
          </BCardBody>
      ...
      <BCol xl="3" md="6">
        <BCard no-body class="card-height-100">
          <BCardBody>
            ...
            <p class="text-muted mb-0"><i class="ri-building-line align-bottom"></i> OWL Delivery <span class="ms-2"><i class="ri-map-pin-2-line align-bottom"></i> California</span></p>
          </BCardBody>
        </BCard>
      </BCol>
      <BCol xl="3" md="6">
        ...
        <BCard no-body>
          <BCardBody class="p-0">
            <BAlert :modal-value="true" variant="warning" class="border-0 rounded-top rounded-0 m-0 d-flex align-items-center" show>
              ...
              <div class="flex-shrink-0">
                <Link href="/pages/profile" class="text-reset text-decoration-underline"><b>Upgrade</b>
                </Link>
              </div>
            </BAlert>
            ...
            <BRow class="align-items-end">
              <BCol sm="8">
                <div class="p-3">
                  ...
                  <div class="mt-3">
                    <Link href="/pages/profile" class="btn btn-success">Upgrade Account!</Link>
                  </div>
                </div>
              </BCol>
              <BCol sm="4">
            ...
            <BRow class="align-items-end">
              <BCol sm="8">
                <div class="p-3">
                  ...
                  <div class="mt-3">
                    <Link href="/pages/profile" class="btn btn-info">Upgrade Account!</Link>
                  </div>
                </div>
              </BCol>
              <BCol sm="4">
        ...
        <BCard no-body>
          <BCardBody class="p-0">
            <BAlert variant="warning" class="border-0 rounded-top rounded-0 m-0 d-flex align-items-center" show>
              ...
              <div class="flex-shrink-0">
                <Link href="/pages/profile" class="text-reset text-decoration-underline"><b>Get Free Gift</b>
                </Link>
              </div>
            </BAlert>
            <div class="d-flex p-3">
              ...
              <div>
                ...
                <div class="mt-3">
                  <Link href="/pages/profile" class="btn btn-secondary">Get a Free Gift</Link>
                </div>
              </div>
            </div>
          </BCardBody>
                  ...
                  <BCol sm="auto">
                    <div class="avatar-group">
                      <div class="avatar-group-item">
                        <BLink href="javascript: void(0);" class="d-inline-block" data-bs-toggle="tooltip" data-bs-placement="top" title="" data-bs-original-title="Stine Nielsen">
                          <img src="@assets/images/users/avatar-1.jpg" alt="" class="rounded-circle avatar-xxs" />
                        </BLink>
                      </div>
                      <div class="avatar-group-item">
                        <BLink href="javascript: void(0);" class="d-inline-block" data-bs-toggle="tooltip" data-bs-placement="top" title="" data-bs-original-title="Jansh Brown">
                          <img src="@assets/images/users/avatar-2.jpg" alt="" class="rounded-circle avatar-xxs" />
                        </BLink>
                      </div>
                      <div class="avatar-group-item">
                        <BLink href="javascript: void(0);" class="d-inline-block" data-bs-toggle="tooltip" data-bs-placement="top" title="" data-bs-original-title="Dan Gibson">
              ...
              <li class="list-group-item ps-0">
                <BRow class="align-items-center g-3">
                  ...
                  <BCol sm="auto">
                    <div class="avatar-group">
                      <div class="avatar-group-item">
                        <BLink href="javascript: void(0);" class="d-inline-block" data-bs-toggle="tooltip" data-bs-placement="top" title="" data-bs-original-title="Frida Bang">
                          <img src="@assets/images/users/avatar-4.jpg" alt="" class="rounded-circle avatar-xxs" />
                        </BLink>
                      </div>
                      <div class="avatar-group-item">
                        <BLink href="javascript: void(0);" class="d-inline-block" data-bs-toggle="tooltip" data-bs-placement="top" title="" data-bs-original-title="Malou Silva">
                          <img src="@assets/images/users/avatar-5.jpg" alt="" class="rounded-circle avatar-xxs" />
                        </BLink>
                      </div>
                      <div class="avatar-group-item">
                        <BLink href="javascript: void(0);" class="d-inline-block" data-bs-toggle="tooltip" data-bs-placement="top" title="" data-bs-original-title="Simon Schmidt">
                          <img src="@assets/images/users/avatar-6.jpg" alt="" class="rounded-circle avatar-xxs" />
                        </BLink>
                      </div>
                      <div class="avatar-group-item">
                        <BLink href="javascript: void(0);" class="d-inline-block" data-bs-toggle="tooltip" data-bs-placement="top" title="" data-bs-original-title="Tosh Jessen">
              ...
              <li class="list-group-item ps-0">
                <BRow class="align-items-center g-3">
                  ...
                  <BCol sm="auto">
                    <div class="avatar-group">
                      <div class="avatar-group-item">
                        <BLink href="javascript: void(0);" class="d-inline-block" data-bs-toggle="tooltip" data-bs-placement="top" title="" data-bs-original-title="Nina Schmidt">
          ...
          <BCol xl="6">
            <BCard no-body class="card-height-100">
              <BCardHeader class="align-items-center d-flex">
                ...
                <div class="flex-shrink-0">
                  <BDropdown variant="link" right toggle-class="text-decoration-none arrow-none p-0" class="card-header-dropdown" no-caret>
                    <template #button-content> <span class="text-muted"><i class="ri-settings-4-line align-middle me-1 fs-15"></i>Settings</span>
                    </template>
                    <BDropdownItem href="#">Edit</BDropdownItem>
                    <BDropdownItem href="#">Remove</BDropdownItem>
                  </BDropdown>
                ...
                <simplebar data-simplebar style="max-height: 364px;" class="p-3">
                  <div class="acitivity-timeline acitivity-main">
                    ...
                    <div class="acitivity-item py-3 d-flex">
                      ...
                      <div class="flex-grow-1 ms-3">
                        ...
                        <div class="d-inline-flex gap-2 border border-dashed p-2 mb-2 w-75">
                          <Link href="/ecommerce/product-details" class="bg-light rounded p-1">
                    ...
                    <div class="acitivity-item py-3 d-flex">
                      ...
                      <div class="flex-grow-1 ms-3">
                        <h6 class="mb-1">Today offers by <Link href="/ecommerce/seller-details" class="link-secondary">
                            Digitech Galaxy</Link>
                        </h6>
                    ...
                    <div class="acitivity-item py-3 d-flex">
                      ...
                      <div class="flex-grow-1 ms-3">
                        ...
                        <p class="text-muted mb-0">Flash sale by <BLink href="javascript:void(0);" class="link-secondary fw-medium">Zoetic Fashion</BLink>
                        </p>
                    ...
                    <div class="acitivity-item py-3 d-flex">
                      ...
                      <div class="flex-grow-1 ms-3">
                        ...
                        <p class="text-muted mb-2"><span class="text-danger">
                            2 days left</span> notification to submit the monthly sales report. <BLink href="javascript:void(0);" class="link-warning text-decoration-underline">Reports
                            Builder</BLink>
                        </p>
      ...
      <BCol xxl="4">
        <BCard no-body class="card-height-100">
          ...
          <BCardHeader class="p-0">
            <BAlert variant="warning" :model-value="true" class="alert-label-icon border-0 rounded-0 m-0 d-flex align-items-center" show>
              <i class="ri-error-warning-line label-icon"></i>
              <div class="flex-grow-1 text-truncate">
                Your free trial expired in <b>17</b> days.
              </div>
              <div class="flex-shrink-0">
                <Link href="/pages/pricing" class="text-reset text-decoration-underline"><b>Upgrade</b></Link>
              </div>
            </BAlert>
          </BCardHeader>
          ...
          <BCardBody class="p-0 pb-2">
            <div>
              <apexchart class="apex-charts" dir="ltr" height="306" :series="audienceChartOptions.series" :options="audienceChartOptions.chartOptions"></apexchart>
            </div>
          </BCardBody>
    ...
    <BRow>
      ...
      <BCol xxl="4" xl="6">
        <BCard no-body class="card-height-100">
          ...
          <BCardBody>
            <apexchart class="apex-charts" dir="ltr" height="210" :series="portfolioChart.series" :options="portfolioChart.chartOptions"></apexchart>
      ...
      <BCol xxl="4">
        <BCard no-body class="card-height-100">
          ...
          <BCardBody>
            <apexchart class="apex-charts" dir="ltr" height="310" :series="topReferralsChart.series" :options="topReferralsChart.chartOptions"></apexchart>
        ...
        <BCard no-body class="card-height-100">
          <BCardBody>
            ...
            <div class="d-flex mb-4 align-items-center">
              <div class="flex-grow-1">
                <h5 class="text-primary fs-18 mb-0 product-price"><span>$22.45</span> <small class="text-decoration-line-through text-muted fs-13">$37.45</small></h5>
              </div>

              <div class="input-step flex-shrink-0">
                <button type="button" class="minus" @click="minusamount()">–</button>
                <input type="number" class="product-quantity " value="2" min="0" max="100" readonly>
                <button type="button" class="plus" @click="plusamount()">+</button>
              </div>
            </div>
      ...
      <BCol xl="3" md="6">
        <BCard no-body class="card-height-100">
          <BCardBody>
            ...
            <div class="d-flex mb-4 align-items-center">
              <div class="flex-grow-1">
                <h5 class="text-primary fs-18 mb-0 product-price"><span>$48.20</span> <small class="text-decoration-line-through text-muted fs-13">$124.10</small></h5>
              </div>
                  ...
                  <ul class="list-unstyled mb-0 pt-2" id="candidate-list">
                    ...
                    <li v-for="(data, index) of resultQuery" :key="index" @click="showdetail(data)">
                      <BLink href="javascript:void(0);" class="d-flex align-items-center py-2">
                        ...
                        <div class="flex-grow-1">
                          <h5 class="fs-13 mb-1 text-truncate"><span class="candidate-name">{{ data.name }}</span> <span class="text-muted fw-normal">{{ data.username }}</span></h5>
            ...
            <BCol lg="6">
              <BCardBody class="text-center">
                ...
                <div class="d-flex gap-2 justify-content-center mb-3">
                  <button type="button" class="btn avatar-xs p-0" v-b-tooltip.hover title="Google">
                    <span class="avatar-title rounded-circle bg-light text-body">
                      <i class="ri-google-line"></i>
                    </span>
                  </button>

                  <button type="button" class="btn avatar-xs p-0" v-b-tooltip.hover title="Linkedin">
                    <span class="avatar-title rounded-circle bg-light text-body">
                      <i class="ri-linkedin-line"></i>
                    </span>
                  </button>
                  <button type="button" class="btn avatar-xs p-0" v-b-tooltip.hover title="Dribbble">
                    <span class="avatar-title rounded-circle bg-light text-body">
                ...
                <div>
                  <BButton type="button" variant="success" class="rounded-pill w-sm"><i class="ri-add-fill me-1 align-bottom"></i> Follow</BButton>
                </div>
              </BCardBody>
            </BCol>
          </BRow>
          ...
          <BCardBody>
            ...
            <form id="custom-card-form" autocomplete="off">
              <div class="mb-3">
                ...
                <input id="card-num-input" class="form-control" maxlength="19" placeholder="0000 0000 0000 0000" @keypress="(e) => customcreditcard(e)" />
              </div>

              <div class="mb-3">
                <label for="card-holder-input" class="form-label">Card Holder</label>
                <input type="text" class="form-control" id="card-holder-input" placeholder="Enter holder name" @keypress="(e) => customcreditcard(e)" />
              </div>
              ...
              <BRow>
                ...
                <BCol lg="4">
                  <div class="cvc">
                    ...
                    <input type="text" id="cvc-input" class="form-control" maxlength="3" @keypress="(e) => customcreditcard(e)" />
                  </div>
                </BCol>
              </BRow>
