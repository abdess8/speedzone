...
return [
    ...
    'notes' => [
        ...
        'orders_create_delivery_included' => 'With `delivery_included: true`, `total_amount` equals `order_amount`: the customer is not charged the shipping on top and the label never mentions it. The fee is not waived — it is still deducted from what you are paid on your invoice.',
    ...
    'fields' => [
        ...
        'delivery_included' => 'Set it when the price you quoted already covers the shipping, so the driver collects the order amount alone.',
