...
return [
    ...
    'notes' => [
        ...
        'orders_create_delivery_included' => 'Avec `delivery_included: true`, `total_amount` est égal à `order_amount` : les frais de livraison ne sont pas encaissés en plus chez le client et n\'apparaissent pas sur l\'étiquette. Ils ne sont pas offerts pour autant — ils restent déduits de votre facture.',
    ...
    'fields' => [
        ...
        'delivery_included' => 'À activer lorsque le prix annoncé au client comprend déjà la livraison : le livreur n\'encaisse alors que le montant de la commande.',
