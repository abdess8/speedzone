...
return [
    ...
    'columns' => [
        ...
        'city' => 'Ville',
        'status' => 'Statut',
        'completed_on' => 'Date livraison / retour',
    ...
    'create' => [
        ...
        'period' => 'Période de livraison / retour (optionnel)',
        'period_hint' => 'Les commandes sont retenues sur leur date de livraison ou de retour, pas sur leur date de création. Laisser vide pour facturer toutes les commandes en attente.',
        'period_start' => 'Du',
        'period_end' => 'Au',
        'preview' => 'Aperçu',
